...
const Customization = () => {
  return (
    <div className='customization-container flex flex-col-reverse lg:flex-row gap-4 py-2 px-6 lg:px-16'>
      <div className='image-container relative h-screen flex-grow w-full lg:w-[50%]'>
        <Image className='absolute' src={bgGradiant1} alt="" />
        <Image className='absolute' src={feastureImg} alt="" />
      </div>
      <div className='content-container pl-1 lg:pl-16 w-full lg:w-[50%] lg:pt-36'>
        <h4 className='uppercase flex items-center gap-2'>
          <Image src={customization_icon} alt="customization" />
          <span className='text-2xl lg:text-[28px] font-bold capitalize'>fully customizable</span>
        </h4>
        <div className='mt-4'>
          <p className='pr-0 lg:pr-12 text-gray-500 text-[18px]'>
